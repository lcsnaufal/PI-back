...
public class SalesPersonDal {
    ...
    //Inserir - Create
    public int inserirUsuario(String name, String lastName, String phoneNumber, String cpf, String address, String email) throws SQLException{
        String sql = "INSERT INTO Users (name, lastName, phoneNumber, cpf, addresss, email) VALUES(?, ?, ?, ?, ?, ?)";
